...
<div class="container">
    <div class="title"> Modifier un compte employé </div>
    <div class="content">
    <form action="edit_empl.php?mat=<?php echo$mat?>" method="POST" enctype="multipart/form-data">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" class="box"  name="prenom"  value="<?php echo $row['prenom'] ?>" />
          </div>

          <div class="input-box">
            <span class="details">Adresse </span>
            <input type="text" class="box"  name="adresse"  value="<?php echo $row['adresse'] ?>" />
          </div>

          <div class="input-box">
            <span class="details">Numéro du téléphone </span>
            <input type="tel" pattern="[0-9]{10}"  class="box" name="num_tel"  value="<?php echo $row['num_tel'] ?>"/>
          </div>
          
          <div class="input-box">
            <span class="details">Mot de passe </span>
            <input type="text" class="box" name="pass"  value="<?php echo $row['password'] ?>" />
          </div>
